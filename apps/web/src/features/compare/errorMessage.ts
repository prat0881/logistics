 ...
 * `MakerPanel.tsx` (Task 4) and re-pasted verbatim into `CheckerPanel.tsx`/`GenerateGate.tsx`
 * (Task 5); hoisted here on review so there's exactly one copy (task-5 review Minor #2).
 */
